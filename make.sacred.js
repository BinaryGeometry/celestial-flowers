...
const purple = 'rgba(163, 194, 216, 0.7)';
const blue   = 'rgba(170, 170, 191, 0.7)';
const green  = 'rgba(117, 181, 097, 0.7)';

// console.log('makeSacred', life.sun)
// var jsonCircles = [
